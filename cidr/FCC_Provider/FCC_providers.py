...
if len(sys.argv) > 1:
    ...
    for i in range(len(data['result']['addressMatches'])):
        ...
        if json_zip == zip:
            ...
            print("---The 15-digit U.S. Census Bureau FIPS code for the census block is: " + target_geoid)
        #else:
            #print("False: " + data['result']['addressMatches'][i]["geographies"]["2020 Census Blocks"][0]["GEOID"])
    print("+++++++++++++++++++++++++++++++++++")
