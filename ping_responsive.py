...
#median distance from the VP group (close, medium far, very far) - RTT*2/3 the speed of light --> 
...
##Median probes , slect the probe 3* further than the max of the min VP and 3* closer than the min of the max VP
